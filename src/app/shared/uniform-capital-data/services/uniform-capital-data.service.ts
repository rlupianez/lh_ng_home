...
// fields
import { fields, group, formFields } from './uniform-capital-data-form';
import { UniformCapitalDataFieldEnum, fixedCapital, variableCapital } from './uniform-capital-data.interfaces';

@Injectable({
  providedIn: 'root'
})
export class UniformCapitalDataService extends BaseService implements OnDestroy {
  ...
  initPanelWithType(editable: boolean, fs: Array<UniformCapitalDataFieldEnum>) {
    let fields;
