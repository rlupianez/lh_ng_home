...
export class EndososService {
  ...
  getPoliza(polizaData){
    ...
    return new Observable( obs => { 
      ...
      combineLatest(polizaServices).subscribe( (res: object[]) => {
  ...
  getCobertura(data){
    ...
    let filtro = {
      ...
      p_endoso: data['endoso'],
      p_tipo_emi: data['tipo_emi']
    };

    return this.apiService.post('/listados/DETALLE_RIESGO_COB_ENDOSO', filtro, false);
  }
